...
class ConvLayer(TrainableLayer):
    ...
    def layer_op(self, input_tensor):
        ...
        # tf.logging.info('Params going into convolution: ')
        # tf.logging.info(f'filter: {conv_kernel}')
        # tf.logging.info(f'strides: {full_stride}')
        # tf.logging.info(f'dilation_rate: {full_dilation}')
        # tf.logging.info(f'padding: {self.padding}')
