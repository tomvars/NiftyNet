    ...
    def layer_op(self, idx=None):
        ...
        while True:
            ...
            if self.csv_reader is not None:
                _, label_dict, _ = self.csv_reader(subject_id=self.reader.get_subject_id(image_id))
                # print('in sampler:', label_dict['modality_label'], self.reader.get_subject_id(image_id))
